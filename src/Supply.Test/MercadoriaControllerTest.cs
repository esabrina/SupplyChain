...
{
    public class MercadoriaControllerTest : IDisposable
    {
        MercadoriaController _controller;
        SupplyDBContext _contextTest;

        public MercadoriaControllerTest()
        {
            ...
            var _repo = new MercadoriaRepository(context);
            _controller = new MercadoriaController(_repo);
        }
        public void Dispose()
        {
        ...
        public void IndexTest()
        {
            ...
            var model = response.Model as List<Mercadoria>;
        ...
        {
            var _data = new Mercadoria()
            {
                Nome = "Merc5",
                Descricao = "descricao xxx4",
                Fabricante = "Fabricante xxx",
                Tipo = "xxx"
            };
        ...
        public void EditOKTest()
        {
            ...
            Mercadoria _obj = (Mercadoria) response.ViewData.Model;
            _obj.Nome = "nome alterado";
            _obj.Descricao = "descricao alterado";
            _obj.Fabricante = "Fabricante alterado";
            _obj.Tipo = "xxx alterado";
        ...
        public void EditErrorRequiredTest()
        {
            ...
            _controller.ModelState.AddModelError("SessionName", "Required");
            var response_update = _controller.Edit(id, _obj);
            var badRequestResult = Assert.IsType<BadRequestResult>(response_update);
